...
/**
 * Two-pane conversation list + thread UI, shared by the admin support center
 * and the seller messages inbox — both list every real conversation the
 * logged-in user has (via /chat/conversations) and let them reply.
 */
export function ChatInbox({ title, subtitle }) {
